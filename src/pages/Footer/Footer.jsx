    ...
    <footer>
              ...
              <div className='d-row d-md-flex justify-content-between align-items-center'>
                ...
                <div className='col-12 col-md-6 col-lg-7'>
                  <ul className='list-unstyled mb-0'>
                    <li>
                      <p>Main Address - Gurdaspur, Punjab 142521</p>
                    </li>
                    <li>
                      <p>Phone Number - 01874292879</p>
                    </li>
                    <li>
                      <p>Email - principalbcetgurdaspur@yahoo.com</p>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className='bg-body-tertiary'>
          <div className='container'>
            <p className='p-3 m-0 text-center'>copyright @ made by Meena</p>
          </div>
        </div>
      </footer>
  )
